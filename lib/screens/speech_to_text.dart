  ...
  void _saveTask() async {
    ...
    try {
      final taskData = {
        ...
        'status': 'To Do', // Changed from 'Pending' to 'To Do' to match other pages
      };
...
// import 'package:speechtotext/screens/auth_service.dart'; // Import AuthService to get user UID
// import 'package:speechtotext/screens/history.dart'; // Import HistoryManager
//
// class TaskFormPage extends StatefulWidget {
//   const TaskFormPage({Key? key}) : super(key: key);
//
...
//   final List<String> _categories = ['Work', 'Personal', 'Study', 'Health'];
//
//   // --- Add instances of AuthService and Firestore ---
//   final AuthService _authService = AuthService();
//   final FirebaseFirestore _firestore = FirebaseFirestore.instance;
//
//   @override
...
//       };
//
//       // Add the task to the "Users_Tasks" collection
//       await _firestore.collection('Users_Tasks').add(taskData);
//
//       // --- Add the task to the local history ---
//       HistoryManager.addHistoryItem(_titleController.text);
//
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(
//           content: Text('Task saved successfully!'),
...
//   String _baseTextForSpeech = '';
//
//   // State variables for emulator detection and status messages
//   bool _isEmulator = false;
//   String _statusMessage = '';
//
//   // --- New state variables for the recording timer ---
//   int _recordingDuration = 0;
//   DateTime? _recordingStartTime;
//
...
//   }
//
//   // --- New method to update the timer every second ---
//   void _updateRecordingDuration() {
//     if (_recordingStartTime != null && _isListening) {
//       Future.delayed(const Duration(seconds: 1), () {
//         if (_isListening && _recordingStartTime != null) {
...
//   }
//
//   // --- New method to format the duration string ---
//   String _formatDuration(int seconds) {
//     int hours = seconds ~/ 3600;
//     int minutes = (seconds % 3600) ~/ 60;
//     int remainingSeconds = seconds % 60;
...
//               ),
//               const SizedBox(width: 8),
//               // --- Display Timer next to Listening text ---
//               Text(
//                 'Listening... ${_formatDuration(_recordingDuration)}',
//                 style: const TextStyle(
//                   fontSize: 14,
...
//             ),
//             _buildSpeechVisualization(),
//             _buildStatusWidget(), // Display emulator/error warnings here
//             Row(
//               children: [
//                 Expanded(
//                   child: _buildTextField(
